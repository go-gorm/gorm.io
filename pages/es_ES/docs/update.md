...
Si sólo quiere actualizar los Campos editados, puede utilizar `Update`, `Updates`
...
Si solo desea actualizar o ignorar algunos campos al actualizar, puede utilizar `Select`, `Omit`
