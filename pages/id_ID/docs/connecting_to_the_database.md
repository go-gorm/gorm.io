...
kita menggunakan [gaussdb-go](https://github.com/HuaweiCloudDeveloper/gaussdb-go)  sebagai database Gaussdb's/sql driver , memungkinkan menyiapkan cache secara default,  unutk menonaktikannya :
