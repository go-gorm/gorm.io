...
GORM's AutoMigrate works well for most cases, but if you are looking for more serious migration tools, GORM provides genric DB interface which might be helpful for you.
